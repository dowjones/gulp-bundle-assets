    ...
    each(Object.keys(config.bundle), function (bundleName) {
      ...
      each(Object.keys(namedBundleObj), function (type) {
        ...
        if (type === BundleKeys.SCRIPTS) {
          streams.push(gulp.src(pathifySrcs.call(this, namedBundleObj[BundleKeys.SCRIPTS], config.base), {base: config.base})
          ...
          streams.push(gulp.src(pathifySrcs.call(this, namedBundleObj[BundleKeys.STYLES], config.base), {base: config.base})
