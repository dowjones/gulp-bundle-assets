...
Sourcemaps.prototype.verify = function (file, enc, cb) {
  if (!file.isStream() && // ignore streams (e.g. browserify) this those will implement their own sourcemaps
    ...
    logger.log("\n" +
      warnPrefix + " Source map is empty for file '" + colors.magenta(file.relative) + "'.\n" +
      warnPrefix + " This is most likely not a problem with '" + colors.cyan('gulp-bundle-assets') + "' itself.\n" +
